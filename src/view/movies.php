...
<body>
    ...
    ?>
    <main>
        <h1 class="text-6xl font-bold py-4">Les films</h1>
                ...
                <tbody>
                    <?php foreach ($allMovies as $movie): ?>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo htmlspecialchars($movie->getTitle()); ?></th> 
                            <td class="px-6 py-4"><?php echo htmlspecialchars($movie->getAuthor()); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($movie->getAvailable() ? 'Oui' : 'Non'); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($movie->getDuration()); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($movie->getGenre()); ?></td>
                            <td class="px-6 py-4 flex">
                                <a href="/<?= Router::use("showMovies", $movie->getId()) ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >Voir</a>
                                <?php
