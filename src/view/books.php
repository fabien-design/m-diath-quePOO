...
<body>
    ...
    ?>
    <main>
        <h1 class="text-6xl font-bold py-4">Les livres</h1>
                ...
                <tbody>
                    <?php foreach ($books as $book): ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4"><?php echo htmlspecialchars($book->getAuthor()); ?></td=>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($book->getAvailable() ? 'Oui' : 'Non'); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($book->getPageNumber()); ?></td>
                            <td class="px-6 py-4 flex">
                                <a href="/<?= Router::use("showBooks", $book->getId()) ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >Voir</a>
                                <?php
